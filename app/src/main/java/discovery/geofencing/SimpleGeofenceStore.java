...
import static discovery.Constants.INVALID_FLOAT_VALUE;
import static discovery.Constants.INVALID_INT_VALUE;
import static discovery.Constants.INVALID_LONG_VALUE;
import static discovery.Constants.KEY_EXPIRATION_DURATION;
import static discovery.Constants.KEY_LATITUDE;
import static discovery.Constants.KEY_LONGITUDE;
import static discovery.Constants.KEY_PREFIX;
import static discovery.Constants.KEY_RADIUS;
import static discovery.Constants.KEY_TRANSITION_TYPE;
...
public class SimpleGeofenceStore {
    ...
    private static final String TAG = "PTP_Simple_Geofence_Store";
